...
from inference import get_metric_BraTs
...
if __name__ == "__main__":
    ...
    model.dataset_type = config.dataset_type
    model.template_dir = os.path.join(dir_prefix, config.filepath_img)
    model.test_dir = os.path.join(dir_prefix, config.h5_2d_img_dir, 'images_ts')
