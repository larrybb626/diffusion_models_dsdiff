...
if __name__ == "__main__":
    ...
    if config.net_mode == "diffusion":
        ...
        model = DSDiffModel.load_from_checkpoint(ckpt_path)
    ...
    # ===============以防万一地址变动================
    # root_dir = os.path.join(dir_prefix,"newnas/MJY_file/CE-MRI/train_result/", task_name)
    ...
    # model.pred_result_dir = os.path.join(model.result_dir, "pred_nii")
    # model.num_workers = 0
    # ================cuda================
