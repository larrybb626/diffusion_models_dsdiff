...
def main(config=None):
    ...
    gt_dir = os.path.join(config.filepath_img, "images_ts_rm")
    pred_dir = os.path.join(result_path, task_name, "pred_nii_" +"rm_"
    ...
    # pred_dir = os.path.join("/data/newnas_1/MJY_file/SOTA_models/DiscDiff_test/Prostate_v_predict_not_all_train_rescale/itk_save_dir","")
    ...
    for idx, filename in enumerate(reversed(pred_list)):
        ...
        mask_file = os.path.join(gt_dir, id_num, "T1CE_body_mask.nii.gz")
